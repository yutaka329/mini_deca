...
class RetinaFacePredictor(object):
    ...
    def get_model(name: str = 'resnet50') -> SimpleNamespace:
        ...
        if name == 'resnet50':
            ...
            #weights=os.path.realpath(os.path.join(os.path.dirname(__file__),'weights', 'mobilenet0.25_Final.pth'))
            return SimpleNamespace(weights=os.path.realpath(os.path.join(os.getcwd(), 'data','weights', 'mobilenet0.25_Final.pth')),
